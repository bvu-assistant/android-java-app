...
import com.bvu.assistant.viewmodel.adapters.NotificationPagerAdapter;
...
public class NotificationFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        NotificationPagerAdapter pagerAdapter = new NotificationPagerAdapter(getFragmentManager(),0);
