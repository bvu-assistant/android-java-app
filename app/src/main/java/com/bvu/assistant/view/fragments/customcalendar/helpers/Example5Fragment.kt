...
import com.bvu.assistant.databinding.Example5CalendarHeaderBinding
import com.bvu.assistant.databinding.Example5EventItemViewBinding
import com.bvu.assistant.databinding.Example5FragmentBinding
import com.bvu.assistant.view.fragments.customcalendar.helpers.*
import com.bvu.assistant.view.fragments.customcalendar.helpers.getColorCompat
import com.bvu.assistant.view.fragments.customcalendar.helpers.layoutInflater
...
class Example5Fragment : Fragment(R.layout.example_5_fragment) {
    private lateinit var mMainActMonthViewChanger: MainActivityMonthViewChanger;
...
//        flightsAdapter.notifyDataSetChanged()
        ...
        class DayViewContainer(view: View) : ViewContainer(view) {
            ...
            val binding = FragmentCalendarDayViewBinding.bind(view)
            init {
...
//                            flightBottomView.setBackgroundColor(view.context.getColorCompat(flights[1].color))
                    ...
                    textView.setTextColorRes(R.color.card_bottom_color)
...
//            val title = "${monthTitleFormatter.format(month.yearMonth).capitalize()}, năm ${month.yearMonth.year}"
...
//        }
    ...
    override fun onAttach(context: Context) {
        ...
        mMainActMonthViewChanger = context as MainActivityMonthViewChanger;
    }
