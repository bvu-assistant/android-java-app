...
public class TabLayoutHelper {
    ...
    public static void setViewPagerTransforming(@NotNull ViewPager viewPager, MyTransformer.Transformer mTransformer) {
        switch (mTransformer) {
            case Fading: {
                viewPager.setPageTransformer(false, MyTransformer.fadeTransformer);
                break;
            }
            ...
            case Flipping: {
                viewPager.setPageTransformer(false, MyTransformer.flipTransformer);
                break;
            }
